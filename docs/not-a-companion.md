...
Slimey is a toy and a technical demo: a slime rendered in three dimensions,
...
- **It is a bit, not a being.** The persona is a system prompt in
  `src/server/persona.js` — a slime from a Japanese RPG. There is nothing behind
  it that knows you or remembers you beyond a short list of details you asked it
  to keep.
